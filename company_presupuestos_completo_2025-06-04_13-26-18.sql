...
-- Datos de la tabla categorias (3 registros)
...
-- Datos de la tabla configuracion (8 registros)
...
-- Datos de la tabla opciones (111 registros)
...
-- Datos de la tabla plazos_entrega (3 registros)
...
-- Datos de la tabla usuarios (1 registros)
