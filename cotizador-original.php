...
<head>
    ...
    <title>Cotizador de Ascensores - Sistema Moderno</title>
...
<body>
    ...
    <header class="public-header">
        <div class="header-content">
            ...
            <div class="header-actions">
                <a href="cotizador_ordenado.php" class="btn btn-secondary">
                    <span id="ordered-icon"></span>
                    Versión Ordenada
                </a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('ordered-icon').innerHTML = modernUI.getIcon('sort');
        ...
        async function cargarCategorias() {
            try {
                ...
                if (data.success) {
                    ...
                    // Ordenar opciones de ascensores por número de paradas
                    ordenarOpciones();
        ...
        function renderCategorias() {
            ...
            // Ordenar categorías: ASCENSORES (1) primero, luego ADICIONALES (2), luego DESCUENTOS (3)
            const categoriasOrdenadas = [...categorias].sort((a, b) => {
                const ordenPrioridad = { 1: 1, 2: 2, 3: 3 }; // ASCENSORES, ADICIONALES, DESCUENTOS
                return (ordenPrioridad[a.id] || 999) - (ordenPrioridad[b.id] || 999);
            });

            container.innerHTML = categoriasOrdenadas.map(categoria => {
                const categoryOptions = opciones.filter(op => op.categoria_id == categoria.id);
            ...
            // Expandir automáticamente ASCENSORES (categoría id=1) si existe
            const categoriaAscensores = categoriasOrdenadas.find(cat => cat.id == 1);
            if (categoriaAscensores && opciones.filter(op => op.categoria_id == 1).length > 0) {
                setTimeout(() => {
                    toggleCategory(1);
                }, 100);
            }
        ...
        function getOptionPrice(opcion) {
            ...
            if (precio && precio > 0) {
                console.log('Formateando precio:', precio, 'Resultado:', modernUI.formatCurrency(precio));
                return `AR$${modernUI.formatCurrency(precio)}`;
            }
        ...
        function updateTotals() {
            ...
            console.log('Subtotal:', subtotal, 'Formato:', modernUI.formatCurrency(subtotal));
            console.log('Total:', total, 'Formato:', modernUI.formatCurrency(total));
            ...
            // Actualizar precios en opciones
