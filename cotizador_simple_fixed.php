...
try {
    ...
    // Obtener todas las opciones (sin alias para evitar problemas)
    $stmt = $pdo->query('
        SELECT 
            opciones.id,
            opciones.categoria_id,
            opciones.nombre,
            opciones.descripcion,
            opciones.precio,
            opciones.precio_90_dias,
            opciones.precio_160_dias,
            opciones.precio_270_dias,
            opciones.descuento,
            opciones.orden,
            categorias.nombre as categoria_nombre
        FROM opciones
        JOIN categorias ON opciones.categoria_id = categorias.id
        ORDER BY categorias.orden ASC, opciones.orden ASC, opciones.id ASC
    ');
...
<head>
    ...
    <title>Cotizador FIXED - <?php echo count($todasOpciones); ?> opciones</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-building"></i> Cotizador FIXED</h1>
            <p>Versión corregida - Sin alias en consultas SQL</p>
        </div>
                    ...
                    <div class="accordion">
                        <div class="accordion-header" onclick="toggleAccordion(this)">
                            <div class="accordion-title">
                                ...
                                <span class="option-count">(<?php echo count($opciones); ?> opciones)</span>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🎯 Cotizador cargado con <?php echo count($todasOpciones); ?> opciones');
            ...
            document.querySelectorAll('.plazo-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    console.log('📅 Plazo cambiado a:', plazoSeleccionado);
                    actualizarPrecios();
                });
            });
            ...
            const primerAccordion = document.querySelector('.accordion-header');
            if (primerAccordion) {
                toggleAccordion(primerAccordion);
            }
        });
        ...
        function toggleOpcion(element) {
            ...
            console.log('🔄 Toggle opción:', nombre, 'Categoría:', categoriaId);
            ...
            if (element.classList.contains('selected')) {
                ...
                console.log('✅ Seleccionada:', nombre, 'Precio:', opcionesSeleccionadas[opcionId].precio_actual);
            }
        ...
        function actualizarPrecios() {
            console.log('💰 Actualizando precios para plazo:', plazoSeleccionado);
        ...
        function actualizarResumen() {
            ...
            console.log('📊 Resumen actualizado - Subtotal:', subtotal, 'Descuento:', descuentoPorcentaje + '%', 'Total:', total);
        }
