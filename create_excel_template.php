...
$opciones = [
    ...
    ['Tipo de Ascensor', 'Ascensor Sin Cuarto de Máquinas', 'Ascensor eléctrico sin necesidad de cuarto de máquinas', 18000.00, 'Sí', 3],
    ...
    ['Capacidad', '8 Personas (640 kg)', 'Capacidad para 8 personas o 640 kg', 3000.00, 'Sí', 3],
    ...
    ['Número de Paradas', '4 Paradas', 'Ascensor con 4 paradas', 4000.00, 'Sí', 3],
    ...
    ['Opciones Adicionales', 'Sistema de Monitoreo Remoto', 'Sistema para monitorear el estado del ascensor de forma remota', 1200.00, 'No', 1]
];
...
echo "Puede descargarlo <a href='$fileName'>aquí</a>";
?> 