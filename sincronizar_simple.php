<?php
// Script simplificado para sincronizar datos del cotizador
...
try {
    ...
    <html>
    <head>
        <title>Sincronización Simple</title>
        <meta charset='UTF-8'>
        <style>
    ...
    if (isset($_POST['sincronizar'])) {
        ...
        // 2. Crear tabla opciones si no existe
        ...
        // 3. Crear tabla plazos_entrega si no existe
        ...
        // 4. Sincronizar productos y opciones manualmente
        // 4.1 Limpiar tabla opciones
        $conn->query("TRUNCATE TABLE opciones");
        
        // 4.2 Insertar productos de ASCENSORES
        ...
        // 4.3 Insertar productos de ADICIONALES
        $conn->query("INSERT INTO opciones (categoria_id, nombre, descripcion, precio, orden) VALUES 
        ...
        // 4.4 Insertar productos de DESCUENTOS
        $conn->query("INSERT INTO opciones (categoria_id, nombre, descripcion, precio, orden) VALUES 
        ...
        mostrarMensaje("Productos y opciones sincronizados manualmente", "success");
        ...
        echo "
        <div class='card'>
            <p>Este script sincronizará datos predefinidos para el cotizador.</p>
            <p>Se realizarán las siguientes acciones:</p>
            <ul>
                <li>Crear o actualizar las categorías (ASCENSORES, ADICIONALES, DESCUENTOS)</li>
                <li>Crear o actualizar los plazos de entrega con sus multiplicadores</li>
                <li>Insertar productos y opciones predefinidos</li>
            </ul>
            <p><strong>Nota:</strong> Esta sincronización no utiliza los datos importados desde Excel, sino que crea datos predefinidos para que el cotizador funcione correctamente.</p>
