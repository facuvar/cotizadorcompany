<?php
/**
 * 🚀 UPLOAD DATABASE COMPLETA A RAILWAY
 * 
 * Este script sube la base de datos completa exportada desde local a Railway
 * Maneja archivos grandes y proporciona reporte detallado del proceso
 */
...
<head>
    ...
    <title>🚀 Upload Database Completa - <?php echo ENVIRONMENT; ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 Upload Database Completa</h1>
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <table>
                    ...
                    <tr><td>Conexión</td><td><?php echo testConnection() ? '✅ Activa' : '❌ Error'; ?></td></tr>
                </table>
            </div>
            ...
            <div class="info-box">
                ...
                <a href="test_config.php" class="btn">🔧 Test Config</a>
            ...
            <div class="info-box">
                ...
                <p><strong>💡 Tip:</strong> Este script maneja automáticamente las foreign keys y ejecuta los statements paso a paso.</p>
            </div>
        </div>
    </div>
