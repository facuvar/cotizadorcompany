...
if ($isLoggedIn) {
    ...
    if ($dbConnected) {
        try {
            ...
            $result = $conn->query("SELECT COUNT(*) as total FROM presupuestos WHERE MONTH(fecha_creacion) = MONTH(CURRENT_DATE())");
            if ($result) {
            ...
            // Ingresos del mes
            $result = $conn->query("SELECT SUM(total) as total FROM presupuestos WHERE MONTH(fecha_creacion) = MONTH(CURRENT_DATE())");
            if ($result) {
            ...
            $result = $conn->query("SELECT * FROM presupuestos ORDER BY fecha_creacion DESC LIMIT 10");
            if ($result) {
            ...
            $result = $conn->query("
                SELECT DATE(fecha_creacion) as fecha, SUM(total) as total 
                FROM presupuestos 
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="importar.php" class="sidebar-item">
            ...
            <div class="content-grid">
                ...
                <div style="grid-column: span 12;">
                    <div class="quick-actions">
                        ...
                        <div class="action-card" onclick="location.href='importar.php'">
                            <div class="action-icon" style="background: var(--accent-warning);">
                                <span id="action-import-icon"></span>
                            </div>
                            <div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($presupuesto['nombre_cliente'] ?? 'Sin nombre'); ?></td>
                                        <td><?php echo htmlspecialchars($presupuesto['email_cliente'] ?? 'Sin email'); ?></td>
                                        <td>
                                            <?php 
                                            $items = json_decode($presupuesto['opciones_json'] ?? '[]', true);
                                            echo count($items);
                                            ?>
                                        </td>
